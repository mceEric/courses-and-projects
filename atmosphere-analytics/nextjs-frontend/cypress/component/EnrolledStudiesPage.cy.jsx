import EnrolledStudiesPage from "../../components/pages/participant-page/studies/enrolled-studies-page/EnrolledStudiesPage";

context("<EnrolledStudiesPage />", function () {
